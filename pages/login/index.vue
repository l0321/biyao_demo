	...
	<view class="title" style="text-align: center;margin-bottom: 10px;font-size: 30px;">
        ...
        <form >
            <div>
                ...
                <input type="text"  id="1" v-model="username">
                <span style="top: 68px;left: 110px;"></span>
            </div>
            <div>
                <label for="password">密&#x3000;码</label>
                <input type="password"  id="2" v-model="password">
        ...
        <nav>
            ...
            <button @click="router.push('/pages/register/index')">
                <span>注册</span>
            </button>
        </nav>
...
<script setup>
import { Login } from '../api/serve.js'
import { ref } from 'vue'
